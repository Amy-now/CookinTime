...
import { auth, logInWithEmailAndPassword, signInWithGoogle, sendPasswordReset } from "../components/firebase";
            ...
            <div className="flex justify-center container" id='background'>
                ...
                <div className="flex justify-center container">
                    <div className="flex justify-center container">
                        ...
                        />
                        <Link to={`/forgot`}>
                            <button id='forgot' className="bg-transparent hover focus:outline-none">Forgot Username/Password?
                            </button>
                        </Link>
                        <button onClick={() => logInWithEmailAndPassword(email, password)} id='login' className="hover focus:outline-none">Login
                        </button>
                    </div>
